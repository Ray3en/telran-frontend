...
import { filterByPriceAction, filterBySaleAction, sortProductsAction } from "../store/productsReducer"
...
// Задание 2
// Измените объект data таким образом, чтобы в качестве значения выводилось число, а не строка в свойствах
// В случае, если from будет пустым - задать значение 0
// Если to будет пустым - задать значение 1000